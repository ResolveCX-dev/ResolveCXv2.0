...
import { CircleQuestionMark, LucideIcon, MessageCircle } from 'lucide-react';
...
const Sidebar = () => {
  return (
    <aside className="flex flex-col min-h-screen w-72 bg-blue-900 text-black rounded-[15px]">
